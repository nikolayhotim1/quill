...
export default function Home() {
	return (
		<>
			<MaxWidthWrapper className='mb12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center'>
				...
				<p className='mt-5 max-w-prose text-zinc-700 sm:text-lg'>
					Quill allows you to have conversations with any PDF
					document. Simply upload your file and start asking
